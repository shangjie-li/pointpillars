...
from pointpillar import build_network, model_fn_decorator
...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='data/pointpillar.yaml', help='specify the config for training')
